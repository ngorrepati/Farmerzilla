...
import './radishes.css';
import Radish_title from './radish_title';
import Radish_form from './radish_form';
import Radish_display from './radish_display';


const apiKey = 'f81f81f13d074f9bb153555a10c7d37b';

class Radishes extends React.Component {
  state = {
  ...
  render() {
    return (
      <div id='radishes'>
        <Radish_title />
        <Radish_form getClimateData={this.getClimateData}/>
        <Radish_display
